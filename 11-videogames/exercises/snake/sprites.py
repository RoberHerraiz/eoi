...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.rect.x = self.x * TILESIZE # esquina superior izquierda
        self.rect.y = self.y * TILESIZE # esquina superior izquierda
    ...
    def move(self):
        ...
        if keystate[pygame.K_LEFT] or keystate[pygame.K_a] and self.dx == 0:
            self.dx = -1
            self.dy = 0
 
        if keystate[pygame.K_RIGHT] or keystate[pygame.K_d] and self.dx == 0:
            self.dx = 1
            self.dy = 0

        if keystate[pygame.K_UP] or keystate[pygame.K_w] and self.dy == 0:
            self.dx = 0
            self.dy = -1

        if keystate[pygame.K_DOWN] or keystate[pygame.K_s] and self.dy == 0:
            self.dx = 0
            self.dy = 1
